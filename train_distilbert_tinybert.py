...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", default="balanced_split_output/train.csv")
    parser.add_argument("--val_file", default="balanced_split_output/val.csv")
    parser.add_argument("--test_file", default="balanced_split_output/test.csv")
